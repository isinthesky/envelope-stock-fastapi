...
지원 전략: ``golden_cross``, ``ma5_breakout``.
...
from src.application.domain.backtest.generators.ma5_breakout import MA5BreakoutSignalGenerator

SUPPORTED_STRATEGY_TYPES = ("golden_cross", "ma5_breakout")
